...
## Mastermind: Implementación del diagrama de dominio aplicando MVC


### Descripción general

Conforme al diagrama de dominio básico, se implementan las clases Board, Combination, SecretCombination, Console y Mastermind, adicionalmente se el enumerado Color en el módulo de models, el modulo de controllers que se encargan de la lógica del juego y la interacción con los modelos, finalmente en el módulos views las clases para el manejo de la interacción con el usuario y el despliegue de información por consola.
...
* BoardController: Controla los intentos y valida si el jugador es ganador o no.
* CombinationController: Valida las combinaciones ingresadas por el usuario y crea el objeto Combimation.
